...
<body>
 ...
 <img class="VBlogo" src="villbill1.png" alt="Village Bank Logo">
	...
	<button class="profbutt" href="myprofile.php">
<img class="prof" src="profile.jpg" alt="Village Bank profile">
	<p class="profi"><b>Profile</b></p></button>
  </header>
...
<div class="homebuttons">
  <img id="VBlogob" src="villbill1.png" alt="Village Bank Logo">
   	<a href="myaccount.php"><b>MY ACCOUNT</b></a><br><br>
	<hr>
...
<p>@villbank.com.zm</p>
<br>
<p>VillBANK is an online platform that allows people in the community save money and at the same time borrow money as a loan with low rates.
 VillBank is better becouse it allows users to deposit and borrow money  remotely as long as the group leader aproves the loan for withdraw transaction.
 It helps in keeping track of the tansactions and gives receipts of members in a transparent and reliable to group bank members.</p>
  </footer>
